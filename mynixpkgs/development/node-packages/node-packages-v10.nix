...
let
  sources = {
    ...
    "bridgedb-6.2.1" = {
      ...
      version = "6.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/bridgedb/-/bridgedb-6.2.1.tgz";
        sha512 = "y8slDtkEJy7bMuoI/pkch53NgaKK/Koj0dhm06bS4CRhXpfvTvPnENh/fRFM4tBzjQYGEeQ8Mw2TDGq/hk+pWA==";
      };
    };
    "browserfs-1.4.3" = {
      name = "browserfs";
